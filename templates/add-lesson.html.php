<section class="container">
    ...
    <form action="" method="POST">
        <div>
            ...
            <input type="text" name="lesson_name" id="lesson_name" placeholder="Ex. Bachelor Smart Developper" required>
        ...
        <div class="formation">
            <div>
                ...
                <input type="text" name="place" id="place" placeholder="Ex. IFA Buisness School" required>
